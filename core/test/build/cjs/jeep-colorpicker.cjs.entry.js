...
const JeepColorpicker = class {
    constructor(hostRef) {
        ...
        this.show = false;
        this._color = null;
        this.getColor = core.createEvent(this, "jeepColorpickerGetColor", 7);
        this.openCpicker = core.createEvent(this, "jeepColorpickerOpen", 7);
        this.closeCpicker = core.createEvent(this, "jeepColorpickerClose", 7);
    }
    //*****************************
    ...
    render() {
        ...
        if (this.show) {
            cpicker = this.innerHideButtons
                ?
                    core.h("jeep-cpicker", { color: this.innerColor, opacity: this.innerOpacity, hidebuttons: this.innerHideButtons, hideheader: this.innerHideHeader, hideopacity: this.innerHideOpacity })
                :
                    core.h("jeep-cpicker", { color: this.innerColor, opacity: this.innerOpacity, buttons: this._cpickerButtons, hideheader: this.innerHideHeader, hideopacity: this.innerHideOpacity });
        }
        return (core.h(core.Host, null, core.h("div", { class: "colorpicker-container" }, this.show
            ?
                cpicker
            :
                core.h("button", { class: "colorpicker-button", onClick: () => this._handleClick() }, this.innerButtons[0]))));
    }
...
exports.jeep_colorpicker = JeepColorpicker;
