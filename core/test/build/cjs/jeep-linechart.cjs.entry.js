...
const JeepLinechart = class {
    ...
    async _init() {
        ...
        if (this.innerStyle != null) {
            const propInstance = common.getCssPropertyFromString(this.innerStyle);
    ...
    _setContainerSize() {
        this.w_width = common.getDim(this._prop.widthPlot, this._wSize.width, "0");
        this.w_height = common.getDim(this._prop.heightPlot, this._wSize.height, "0");
    ...
    _createTitle() {
        if (this.innerTitle != null) {
            ...
            let pos = { x: Math.round(this.w_width / 2), y: common.convertCSSNumber(this._prop.ftTiSize) + 10 };
            if (!this._update) {
    ...
    _createAxis() {
        ...
        // find the axes range
        this._lenY = axisRange(this.innerData, "y", intervalY, common.convertCSSBoolean(this._prop.yZero));
        if (this._label) {
            this._lenX = axisRange(this.innerData, "label", intervalX);
        }
        else {
            this._lenX = axisRange(this.innerData, "x", intervalX, common.convertCSSBoolean(this._prop.xZero));
        }
        ...
        yft = Math.floor(common.convertCSSNumber(this._prop.ftLbSize));
    ...
    _createLegend() {
        ...
        if (common.convertCSSBoolean(this._prop.legendTop)) {
    ...
    render() {
        if (this.status.status === 200) {
            ...
            return (core.h(core.Host, null, core.h("div", { id: "div-linechart-container" }, core.h("div", { id: "div-linechart-chart" }, core.h("svg", { id: "svg-linechart", width: this.w_width.toString(), height: this.w_height.toString(), viewBox: viewBox }, core.h("rect", { id: "svg-border-rect", class: "border-rect hidden", x: "0", y: "0", width: this.w_width.toString(), height: this.w_height.toString(), stroke: this._prop.bdColor, "stroke-width": this._prop.bdWidth, fill: "none", "fill-opacity": "0" }))))));
        }
        else {
            return (core.h("div", { id: "div-error-message" }, core.h("p", { id: "p-error-message" }, this.status.message)));
        }
    }
...
exports.jeep_linechart = JeepLinechart;
