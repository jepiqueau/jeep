...
import { createSVGElement, createMarker, createText, updateText, textScale, createLine, updateLine, axisRange, axisConvertY, measureLegend, createLegendLines, removeChilds, axisConvertX, createPolyline, updatePolyline, createAnimation, getTotalLength, createLineLabel, getNearest, getBoundingClientRect } from '../../utils/chart-svgelements';
export class JeepLinechart {
    ...
    render() {
        if (this.status.status === 200) {
            ...
            return (h(Host, null,
                h("div", { id: "div-linechart-container" },
                    h("div", { id: "div-linechart-chart" },
                        h("svg", { id: "svg-linechart", width: this.w_width.toString(), height: this.w_height.toString(), viewBox: viewBox },
                            h("rect", { id: "svg-border-rect", class: "border-rect hidden", x: "0", y: "0", width: this.w_width.toString(), height: this.w_height.toString(), stroke: this._prop.bdColor, "stroke-width": this._prop.bdWidth, fill: "none", "fill-opacity": "0" }))))));
        }
        else {
            return (h("div", { id: "div-error-message" },
                h("p", { id: "p-error-message" }, this.status.message)));
        }
    }
    static get is() { return "jeep-linechart"; }
        ...
        "getStatus": {
            "complexType": {
                ...
                "references": {
                    ...
                    "Status": {
                        "location": "import",
                        "path": "../../global/interfaces/jeep-linechart"
                    }
                },
    ...
    static get watchers() { return [{
            ...
            "propName": "xtitle",
            "methodName": "parseXTitleProp"
        }, {
            "propName": "ytitle",
            "methodName": "parseYTitleProp"
        }, {
            "propName": "data",
            ...
            "propName": "animation",
            "methodName": "parseAnimationProp"
        }, {
            "propName": "cborder",
            "methodName": "parseBorderProp"
        }, {
            "propName": "delay",
            "methodName": "parseDelayProp"
        }]; }
}
;
